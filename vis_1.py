...
""" Variante bei der die Boxen mit in der gt Datei sind """
...
def visualize_file(
    ...
    for i, box in enumerate(boxes):
        ...
        for j, idx in enumerate(z_indices):
            img_slice = cv2.cvtColor(imgs[idx].copy(), cv2.COLOR_GRAY2RGB)
            gt_current_class = np.where(gts[idx] == i + 1, 1, 0)
...
pfad_gt = "/Users/ricardabuttmann/Desktop/CVPR/SegFM3D/3D_val_gt_interactive_seg/CT"
pfad_im = "/Users/ricardabuttmann/Desktop/CVPR/SegFM3D/3D_val_npz/CT"
pfad_ziel = "/Users/ricardabuttmann/Desktop/CVPR/Bilder/3D_val_Bilder/CT"
